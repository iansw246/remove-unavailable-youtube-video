...
export function dataFormatToFileExtension(format: DataFormat): string | undefined {
...
export default function usePlaylistItemsExportText(playlistItems: PlaylistItem[], playlistDataFormat: DataFormat): string {
    return useMemo(() => {
