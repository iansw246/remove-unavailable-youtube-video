...
function App() {
  ...
  const onTokenClientLoadFail = useCallback((error: unknown) => {
    ...
    setErrorBody(
      <Typography>
        Please check your network connection or brower blocking settings.
      </Typography>,
    );
  ...
  return (
    <>
      ...
      <Typography>
        To get started, first select your region. Then choose whether to find
        videos in a specific playlist or all your own playlists.
      </Typography>

      <Typography variant="caption">
        This app is unaffiliated with YouTube or Google.{" "}
      </Typography>
